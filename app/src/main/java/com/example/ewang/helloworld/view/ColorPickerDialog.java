...
public class ColorPickerDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int height = (int) (MyApplication.getScreenHeight() * 0.5f);
        int width = (int) (MyApplication.getScreenWidth() * 0.7f);
        ColorPickerVerticalView myView = new ColorPickerVerticalView(context, height, width);
        setContentView(myView);
        setTitle(title);
    }

    private class ColorPickerVerticalView extends View {
        private Paint mPaint;//渐变色环画笔
        private Paint mCenterPaint;//中间圆画笔
        private Paint mLinePaint;//分隔线画笔
        private Paint mRectPaint;//渐变方块画笔
        private String colorStr;//颜色字符串
        ...
        public ColorPickerVerticalView(Context context, int height, int width) {
            super(context);
            ...
            rectTop = r + mPaint.getStrokeWidth() * 0.5f +
                    mLinePaint.getStrokeMiter() * 0.5f + 80;
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.translate(mWidth / 2 - 120, 70);

            canvas.drawText(colorStr, 0, 0, mCenterPaint);

            //移动中心
            canvas.translate(120, mHeight / 2 - 120);
