...
public class ColorPickerHorizontalView extends View {
    ...
    public ColorPickerHorizontalView(Context context, int height, int width, int mInitialColor, OnColorChangedListener onColorChangedListener) {
        super(context);
        this.mHeight = height;
        ...
        r = height / 2 * 0.9f - mPaint.getStrokeWidth() * 0.5f;

        //中心圆参数
        mCenterPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mCenterPaint.setColor(mInitialColor);
        mCenterPaint.setStrokeWidth(5);
        mCenterPaint.setTextSize(50);
        ...
        rectRight = rectLeft + 70;
        rectBottom = r + mPaint.getStrokeWidth() * 0.5f;

        mListener = onColorChangedListener;

        colorStr = "#" + Integer.toHexString(mInitialColor).substring(2).toUpperCase();
    }

    @Override
    protected void onDraw(Canvas canvas) {

        canvas.translate(100, mHeight / 2 - 100);

        drawTextWithRotation(canvas, colorStr, 0, 0, mCenterPaint, 90);

        //移动中心
        canvas.translate(mWidth / 2 - 100, 100);
        ...
        rectShader = new LinearGradient(0, rectTop, 0, rectBottom, mRectColors, null, Shader.TileMode.MIRROR);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                colorStr = "#" + Integer.toHexString(mCenterPaint.getColor()).substring(2).toUpperCase();
    ...
    void drawTextWithRotation(Canvas canvas, String text, float x, float y, Paint paint, float angle) {
        if (angle != 0) {
